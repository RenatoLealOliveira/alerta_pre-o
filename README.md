...
*   **🔍 Motor Híbrido de Busca**:
    ...
    *   **Google Shopping**: Integração via API (`Serper do Google`) para comparar preços em grandes varejistas (Amazon, Magazine Luiza, Casas Bahia).
...
---
Desenvolvido por **[Seu Nome]** para fins de portfólio e estudos em Automação e Desenvolvimento Web.
